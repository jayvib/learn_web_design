...
.body {
  ...
  line-height: 175%;
  margin: 0 15% 0;
  /*background-image: url(../../../../assets/images/chapter13/summer-menu/bullseye.png);*/
  /*background-position: center 200px;*/
  /*background-image: url(../../../../assets/images/chapter13/summer-menu/blackgoose.png);*/
  ...
  background:
    #d2dc9d url("../../../../assets/images/chapter13/summer-menu/blackgoose.png") no-repeat fixed center 32%;
...
header {
  ...
  text-align: center;
  background:
      url(../../../../assets/images/chapter13/summer-menu/purpledot.png) repeat-y left top,
      url(../../../../assets/images/chapter13/summer-menu/purpledot.png) repeat-y right top,
      url(../../../../assets/images/chapter13/summer-menu/gooseshadow.png) no-repeat 90% bottom;

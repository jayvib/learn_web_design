<template>
  <div>
    ...
    <img src="/images/jenskitchen/spoon.gif" alt="Spoon"/>
    <p>
      <router-link to="/jenkitchen/recipe/salmon">👉 Try this with Garlic Salmon</router-link><br/>
      <router-link to="/jenkitchen">🏠 Back to the home page</router-link>
    </p>
